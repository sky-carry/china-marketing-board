...
const COLS = [
  ...
  { key:'rt_real_pay',     label:'当天点击退后付款', width:130, type:'money', group:'back' },
  { key:'rt_real_roi',     label:'当天点击退后ROI', width:120, type:'roi', group:'back' },
...
const TIPS = {
  ...
  conversions: '转化数：各平台统计的转化事件数（如下单/表单提交等，具体口径取决于各平台的转化跟踪设置）',
  conversion_rate: '转化率 = 转化数 / 点击量 × 100%',
...
/* 投放属性筛选：两两一组，用底色分成三组 */
.meta-group { display: flex; gap: 12px; align-items: flex-end; padding: 2px 10px 5px; border-radius: 8px; border: none; }
